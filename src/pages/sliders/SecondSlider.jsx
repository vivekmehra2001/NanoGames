...
function SecondSlider() {
  ...
  return (
    <div className="w-full sm:w-60 p-4 sm:p-7 h-auto sm:h-52">
      <p className="text-white h-10 w-full sm:w-auto font-semibold text-sm sm:text-base">
        <span className="text-yellow-400">Top </span>Winning Games
      </p>
          ...
          <div key={index} className="slide-item h-auto sm:h-14">
            <div className="flex items-center">
              ...
              <span className="text-white text-xs sm:text-sm">
                <p>
                  Profit:{" "}
                  <span className="text-[rgb(67,169,9)] font-medium">
                    {item.profit}
                  </span>
                </p>
                <p>In {item.game}</p>
